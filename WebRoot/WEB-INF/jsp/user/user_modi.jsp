      ...
      <div id="navi">                        
        ...
        <div id="main">            
           ...
           <!-- commandName指定表单显示的是Model中的哪个对象 -->
            <form:form action="updateUser.from" method="post" commandName="user"  cssClass="main_form">
                
            	<div class="text_info clearfix">
                <span>ID：</span></div>
                <div class="input_info">
                    <form:input path="user_id" cssClass="width300" readonly="true"/>
                </div>
       
                <div class="text_info clearfix">
                <span>用户名：</span></div>
                <div class="input_info">
                    <form:input path="user_name" cssClass="width300" readonly="true"/>
                </div>
                 
                <div class="text_info clearfix">
                <span>密码</span></div>
                <div class="input_info">
                    <form:input path="password" cssClass="width300" />
                    <span class="required">*</span>
                    <div class="validate_msg_short" id="password_name_error"></div>
                </div>
                ...
                <span>权限</span></div>
                <div class="input_info">
                    <form:input path="right" cssClass="width300" />
                </div>
