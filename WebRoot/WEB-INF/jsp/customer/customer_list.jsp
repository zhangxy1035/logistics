                ...
                <div id="data">            
                    <table id="datalist">
                        <tr>
                            ...
                            <th>客户姓名</th>
                            <th>身份证号码</th>
                            <th class="width100">工作单位</th>
                            <th>座机</th>
                            <th>移动电话</th>
                            <th class="width200">联系地址</th>
                            <th>邮编</th>
                            <th>邮件</th>
                    ...
                    <c:forEach items="${customers}" var="cu">
                        <tr>
                            ...
                            <td><input type="button" value="更新" class="btn_modify" onclick="location.href='toUpdate.from?customer_id=${cu.customer_id}';" />
                               ...
                               <input type="button" value="订购信息"  onclick="location.href='toFindOrderInfo.from?customer_id=${cu.customer_id}';" /></td>
                        </tr>
                    </c:forEach>
                    </table>
                </div>
