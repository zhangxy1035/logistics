        ...
        <div id="main">            
            ...
            <form action="addCustomer.from" onsubmit="return doSubmit();" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" class="width300" name="customer_name" id="customer_name"/>
                ...
                <span>身份证号码：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="identity_no" id="identity_no"/>
                    <span class="required">*</span>
                ...
                <span>工作单位：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="job_add" id="job_add"/>
                </div>
                <div class="text_info clearfix">
                <span>座机：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="tel" id="tel"/>
                </div>
                 <div class="text_info clearfix">
                <span>移动电话：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="cellphone" id="cellphone"/>
                    <span class="required">*</span>
                ...
                <span>联系地址：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="adds" id="adds"/>
                    <span class="required">*</span>
                ...
                <span>邮编：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="post" id="post"/>
                </div>
