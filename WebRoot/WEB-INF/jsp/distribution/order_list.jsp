...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="navi">                        
            <ul id="menu">
               ...
               <li><a href="../distribution/order_list.from" class="substation_on"></a></li>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">                        
                    ...
                    <input type="button" value="增加配送单据" class="btn_add" onclick="location.href='toAdd.from';" />
                </div> 
                <!--数据区域：用表格展示数据-->
                <div id="data">            
                    <table id="datalist">
                    ...
                    <c:forEach items="${order}" var="ord">
                        <tr>
                            ...
                            <td>${ord.product_account}</td>
                            <td>${ord.pay_money}</td>
                            <td>${ord.customer_id}</td>
                            <td>${ord.start_date}</td>
                            <td>${ord.deadline}</td>
                            <td>${ord.return_reason}</td>
