    ...
    <body>
       ...
       <div id="navi">                        
            <ul id="menu">
               ...
               <li><a href="../dcc/transfer_list.from" class="dcc_on"></a></li>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div id="data">            
                    ...
                    <c:forEach items="${transfer}" var="as">
                        <tr>
                            <td>${as.transfer_id}</td>
                            <td>${as.order_id}</td>
                            <td>${as.mission_id}</td>
                            <td>${as.customer_id}</td>
                            <td>${as.warehouse_id}</td>
                            <td>${as.transfer_date}</td>
                            <td>${as.transfer_type}</td>
                            <td>${as.transfer_status}</td>
